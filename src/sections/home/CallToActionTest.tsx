...
const CTABannertest = () => {
    return (
        <section id="calltoaction" className="relative w-full bg-zinc-100 px-4 sm:px-8 md:px-16 lg:px-24 py-10 sm:py-14 overflow-visible">
            {/* Concentric Circles Background */}
            <div className="hidden absolute left-1/2 -translate-x-1/2 pointer-events-none z-0
                w-[600px] h-[600px] top-[50px]
                sm:w-[800px] sm:h-[800px] sm:top-[60px]
                md:w-[1000px] md:h-[1000px] md:top-[80px]
                lg:w-[1464px] lg:h-[1464px] lg:top-[114px]
                flex items-center justify-center"
            >
                {/* Big Circle */}
                <div className="absolute rounded-full border border-[#E0E2E8] w-full h-full" />
                {/* Medium Circle */}
                <div className="absolute rounded-full border border-[#E0E2E8] w-[88.25%] h-[88.25%]" />
                {/* Small Circle */}
                <div className="absolute rounded-full border border-[#E0E2E8] w-[77.18%] h-[77.18%]" />
            </div>

            <div className="relative z-10 bg-[#5A81FA] rounded-[4rem] max-w-6xl mx-auto min-h-[280px] sm:min-h-[320px] flex items-center overflow-hidden md:overflow-visible">
