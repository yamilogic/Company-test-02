...
import blogImg1 from '@/assets/All-req/fbdbbf7aa210c9cdc1b094f50d39fb159b216847.jpg';
import blogImg23 from '@/assets/blog/Group 14.svg';
import blogImg4 from '@/assets/All-req/3023621879303a518b30a4ceb13054005cdd978a.png';

export default function BlogSection() {
    const getPostImage = (post: any) => {
        if (post.id === 1) return blogImg1;
        if (post.id === 2 || post.id === 3) return blogImg23;
        if (post.id === 4) return blogImg4;
        return null;
    };
            ...
            <div className="max-w-[1312px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8">
                    {posts.map((post) => {
                        ...
                        ${post.hasImage ? 'text-zinc-200' : 'text-zinc-500'}`}>
                                        {post.desc}
                                    </p>
                                </div>
