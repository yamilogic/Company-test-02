...
import blogImg1 from '@/assets/blog/Group 22.svg';
import blogImg4 from '@/assets/blog/Group 24.svg';
...
const ImageCard = ({
    ...
    return (
        ...
        >
            ...
            {!imgError && (
                <div
                    className={`absolute inset-0 transition-opacity duration-500 ${imgLoaded ? 'opacity-100' : 'opacity-0'
                        }`}
                >
                    <Image
                        src={post.image}
